                        ...
                        child: IconButton(
                            ...
                            onPressed: () {
                              ShowCaseWidget.of(context)
                                  .startShowCase([_day, _time, _prof,_next,_export,_import]);
                              if (kDebugMode) {
                                print("lets play");
                              }
                            },
                    ...
                    Padding(
                      padding: EdgeInsets.symmetric(
                          horizontal: (SizeConfig.screenWidth > 600)
                              ...
                              : SizeConfig.safeBlockHorizontal * 12),
                      child: Row(
                        mainAxisAlignment: (SizeConfig.screenWidth > 848)? MainAxisAlignment.start:MainAxisAlignment.center,
                        children: [
                          Text(
                            'Input your details',
                            style: TextStyle(
                ...
                Form(
                  ...
                  child: Column(
                    children: [
                      ...
                      Padding(
                        padding:  EdgeInsets.symmetric(horizontal: SizeConfig.safeBlockHorizontal * 10,vertical: 40),
                        child: (SizeConfig.screenWidth > 848)? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,
                          children: [
