import 'package:crs_scheduler/screens/PrimeDash.dart';
                  ...
                  children: [
                    ...
                    SizedBox(
                      ...
                      child: ElevatedButton(
                        style:  ElevatedButton.styleFrom(backgroundColor: const Color(0xff8B1538)),
                        onPressed: () {
                          if (_formKey.currentState!.validate()) {
                            ...
                            ScaffoldMessenger.of(context).showSnackBar(
                              const SnackBar(
                                  content: Text('Saving details for your session')),
                            );
                            Navigator.push(
                                context,
                                MaterialPageRoute(
